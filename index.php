...
<head>
    ...
    <?php
    define('CSSPATH', 'http://localhost/superadmin/view/css/'); //define css path
    define('JSPATH', 'http://localhost/superadmin/view/js/'); //define css path
    ...
    <div class="container">
        ...
        <div class="row text-center mt-5" id="login">
            <div class="col-sm-12">
                ...
                <a href="superadmin"><i class="fa fa-user-plus" aria-hidden="true"></i> SuperAdmin</a>
            </div>
        </div>
    </div>
