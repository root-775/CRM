    ...
    <form action="" method="post" autocomplete="off">
        ...
        <div class="p-1" style="border-bottom: 5px solid #ccc; border-color: royalblue;">
            ...
            <div class="row">
                ...
                <div class="col-sm-2">
                    ...
                    <input type="number" class="form-control" name="l_passenger_net_amount" required>
                </div>
                <div class="col-sm-2">
                    MCO <span class="text-danger font-weight-bold">*</span>
                    <input type="number" class="form-control" name="l_mco" required>
                </div>
                <div class="col-sm-2">
        ...
        <div class="p-1" style="border-bottom: 5px solid #ccc; border-color: royalblue;">
            ...
            <div class="row">
                ...
                <div class="col-sm-2">
                    Net. Amount
                    <input type="number" class="form-control" name="l_a_net_amount">
                </div>
                <div class="col-sm-2">
                    MCO
                    <input type="number" class="form-control" name="l_a_mco">
                </div>
                <div class="col-sm-2">
                    Gross
                    <input type="number" class="form-control" name="l_a_gross">
                </div>
            </div> <br>
        </div>
        ...
        <div class="p-1" style="border-bottom: 5px solid #ccc; border-color: royalblue;">
            ...
            <div class="row">
                <div class="col-sm-3">
                    Transaction Type<span class="text-danger font-weight-bold">*</span>
                    <select name="l_p_transaction_type" id="" class="form-control" required>
                        <option value="">None</option>
            ...
            <div class="row">
                ...
                <div class="col-sm-3">
                    ...
                    <input type="text" class="form-control" name="l_p_card_cvv" maxlength="3" required>
                </div>
            </div> <br>
            <div class="row">
                <div class="col-sm-4">
...
if (isset($_POST['insetdata'])) {
    ...
    if ($this->obj->insertData($allData, $commentData)) {
        $this->obj->GetDdata(10);
        echo '<script>alert("congratulations Data was saved :)");</script>';
    }
}
