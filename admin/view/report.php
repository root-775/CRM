...
<?php if (isset($_POST['pin']) && $_POST['pass'] == '1234') { ?>
    ...
    <table id="example" class="" border="1">
        ...
        <tbody>
            ...
            ?>
                <tr style="background-color: <?=$color ?>;">
                    <td class="text-center"><a href="index.php?controller=admin&function=dataView&id=<?= $row['l_confirmation_no'] ?>" target="_blank"><i class="fa fa-eye" aria-hidden="true"></i></a></td>
