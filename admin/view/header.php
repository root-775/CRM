...
// file:///C:/xampp/htdocs/english/admin/view/js/bootstrap.min.js
  define('CSSPATH', 'http://localhost/english/admin/view/css/'); //define css path
  define('JSPATH', 'http://localhost/english/admin/view/js/'); //define css path
